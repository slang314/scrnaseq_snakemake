...
# =============================================================================
# 14b. CELL TYPE DIFFERENTIAL EXPRESSION (requires CellTypist annotations)
# =============================================================================
if 'celltypist_label' in adata.obs.columns:
    print("\n" + "=" * 60)
    print("14b. Cell type differential expression")
    print("=" * 60)
    ...
    os.makedirs(f"{OUTPUT_DIR}/figures/volcano_individual", exist_ok=True)
    ...
    plt.tight_layout()
    plt.savefig(f"{OUTPUT_DIR}/figures/volcano_plots_all_celltypes.png", dpi=150, bbox_inches='tight')
    plt.close()
    print(f"Saved: {OUTPUT_DIR}/figures/volcano_plots_all_celltypes.png")
    ...
    for celltype in sorted(cell_types):
        ...
        plt.tight_layout()
        plt.savefig(f"{OUTPUT_DIR}/figures/volcano_individual/volcano_{safe_name}.png", dpi=150, bbox_inches='tight')
        plt.close()

    print(f"Saved {len(cell_types)} individual volcano plots to {OUTPUT_DIR}/figures/volcano_individual/")
else:
    print("\nSkipping cell type DE (no celltypist_label column)")
